...
namespace TouchInputSample
{
    /// <summary>
    /// Simple touch input example for a touch panel.
    /// </summary>
    public class SimpleTouchInput : nanoFramework.UI.Application
    {
        /// <summary>
        ...
        protected class MyWindow : Window
        {
            ...
            protected override void OnTouchDown(TouchEventArgs e)
            {
                ...
                text.TextContent = "TouchDown (" + x.ToString() + "," + y.ToString() + ")";
            ...
            public override void OnRender(DrawingContext dc)
            {
                ...
                if (pointIndex > 1)
                {
                    ...
                    {
                        dc.DrawLine(pen2, Points[i - 1].x, Points[i - 1].y, Points[i].x, Points[i].y);
                    }
                }
            }
        }
